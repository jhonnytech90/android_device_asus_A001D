...
# Broken rules — kernel 3.18 legado
...
# Display — lcd_density=480 confirmada via getprop da ROM Oreo
...
# Partições — confirmadas via df da ROM Oreo
# system:  3.3GB  (/dev/block/mmcblk0p24)
# vendor:  775MB  (/dev/block/dm-0)
# cache:   232MB  (/dev/block/mmcblk0p26)
# data:    52GB   (/dev/block/mmcblk0p55) — versão 64GB
BOARD_BOOTIMAGE_PARTITION_SIZE     := 67108864
BOARD_PERSISTIMAGE_PARTITION_SIZE  := 33554432
BOARD_FLASH_BLOCK_SIZE             := 131072
BOARD_SYSTEMIMAGE_PARTITION_SIZE   := 3545169920
BOARD_CACHEIMAGE_PARTITION_SIZE    := 243269632
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 67108864
BOARD_USERDATAIMAGE_PARTITION_SIZE := 55588593664
...
TARGET_LD_SHIM_LIBS := \
    ...
    /vendor/lib64/hw/camera.msm8953.so|libshims_camera.so

# Soong namespaces
PRODUCT_SOONG_NAMESPACES += $(DEVICE_PATH)

# Treble — Oreo VNDK Full, sem BOARD_VNDK_RUNTIME_DISABLE
