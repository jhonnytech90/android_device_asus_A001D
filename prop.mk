...
# Display — A001D: 1080x2246, lcd_density=420
PRODUCT_PROPERTY_OVERRIDES += \
    debug.egl.hw=0 \
...
# Fingerprint (traseiro — Goodix GF3208)
PRODUCT_PROPERTY_OVERRIDES += \
    persist.qfp=false
...
# Rádio — DSDS (Dual SIM Dual Standby)
PRODUCT_PROPERTY_OVERRIDES += \
...
# ── PROPS REAIS DO OREO (confirmadas via getprop) ──────────────────────────

# DPM — valor real do Oreo
PRODUCT_PROPERTY_OVERRIDES += \
    persist.vendor.dpm.feature=11 \
    persist.vendor.dpm.nsrm=1 \
    persist.vendor.dpm.tcm=2

# Radio — valores reais confirmados
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.vendor.ril.oem.nosim.errproceed=1
...
# Audio Speaker Protection — desabilitado no hardware stock
PRODUCT_PROPERTY_OVERRIDES += \
